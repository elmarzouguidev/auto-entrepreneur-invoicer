                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                @include('theme.livewire.commercial.invoice.create.info')
                                ...
                                @include('theme.livewire.commercial.invoice.create.b_info')
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-4">
                                <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                    <input name="hasproducts" wire:model="hasProducts" class="form-check-input"
                                        type="checkbox" id="hasProducts">
                                    <label class="form-check-label" for="hasProducts">Avec Produits</label>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-4">
                                @if ($hasProducts)
                                    @include('theme.livewire.commercial.invoice.create.add_products')
                                @else
                                    @include('theme.livewire.commercial.invoice.create.add_articles')
                                @endif
                            </div>
                            <div class="col-lg-6">
