    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="mb-4">
                ...
                <select name="client" class="form-control  @error('client') is-invalid @enderror" required readonly>
                    <option value="{{ isset($client) ? $client->id : '' }}">{{ isset($client) ? $client->entreprise : '' }}
                    </option>
                </select>
                @error('client')
                    <span class="invalid-feedback" role="alert">
    ...
    <div class="docs-options">
        ...
        <div class="input-group mb-4">
            ...
            <input type="text" class="form-control @error('code') is-invalid @enderror" name="code"
                value="{{ $avoirNumber }}" aria-describedby="invoice_prefix" readonly>
            @error('code')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
