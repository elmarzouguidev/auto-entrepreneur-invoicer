                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                                ...
                                                <optgroup label="Factures">
                                                    ...
                                                    @foreach ($invoices as $invoice)
                                                        <option value="{{ $invoice->uuid }}">
                                                            {{ $invoice->full_number }} :
                                                            {{ $invoice->formated_price_total }} MAD
                                                        </option>
                                                    @endforeach
                                                </optgroup>
                                            </select>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                ...
                                                <select name="bill_mode"
                                                    class="form-select @error('bill_mode') is-invalid @enderror"
                                                    required>
                                                    <option value=""></option>
                                    ...
                                    <div class=" mb-4">
                                        <label>Note</label>
                                        <textarea name="notes" id="textarea" class="form-control @error('notes') is-invalid @enderror" maxlength="225"
                                            rows="2"></textarea>
