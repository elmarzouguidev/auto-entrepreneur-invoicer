<div class="modal fade addInvoiceModal " data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
    aria-labelledby=orderdetailsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id=orderdetailsModalLabel">Ajouter une facture d'achat </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">

                <form method="post" action="{{ route('buy:invoices.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-8">
                                    <input id="code" name="code" type="text"
                                        ...
                                        placeholder="Entrer le numéro de facture" required>
                                    @error('code')
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-8">
                                    <input id="price_ht" name="price_ht" type="text"
                                        ...
                                        placeholder="Entrer le Montant HT de la facture " required>
                                    @error('price_ht')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-8">
                                    <input class="form-control @error('invoice_file') is-invalid @enderror"
                                        name="invoice_file" type="file" required />
                                    @error('invoice_file')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
