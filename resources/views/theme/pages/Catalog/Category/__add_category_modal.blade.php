<div class="modal fade addCategoryModal " data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{ route('commercial:categories.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input id="name" name="name" type="text"
                                        ...
                                        placeholder="Entrer le nom du catégorie " required>
                                    @error('name')
